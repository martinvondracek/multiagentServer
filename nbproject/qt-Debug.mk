...
# Generated by qmake (2.01a) (Qt 4.8.6) on: ?t máj 21 21:32:16 2015
...
SOURCES       = CoordinationPosition.cpp \
		CoveredArea.cpp \
		CoveredAreas.cpp \
		DbConnector.cpp \
		NavigaciaUtil.cpp \
...
OBJECTS       = build/Debug/GNU-Linux-x86/CoordinationPosition.o \
		build/Debug/GNU-Linux-x86/CoveredArea.o \
		build/Debug/GNU-Linux-x86/CoveredAreas.o \
		build/Debug/GNU-Linux-x86/DbConnector.o \
		build/Debug/GNU-Linux-x86/NavigaciaUtil.o \
		build/Debug/GNU-Linux-x86/Obstacle.o \
		build/Debug/GNU-Linux-x86/Position.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Debug/GNU-Linux-x86/DP_server1.0.0/ && $(COPY_FILE) --parents CoordinationPosition.h CoveredArea.h CoveredAreas.h DbConnector.h NavigationUtil.h Obstacle.h Position.h Server.h SocketConnector.h SocketUtil.h serverForm.h build/Debug/GNU-Linux-x86/DP_server1.0.0/ && $(COPY_FILE) --parents CoordinationPosition.cpp CoveredArea.cpp CoveredAreas.cpp DbConnector.cpp NavigaciaUtil.cpp Obstacle.cpp Position.cpp Server.cpp SocketConnector.cpp SocketUtil.cpp main.cpp serverForm.cpp build/Debug/GNU-Linux-x86/DP_server1.0.0/ && $(COPY_FILE) --parents serverForm.ui build/Debug/GNU-Linux-x86/DP_server1.0.0/ && (cd `dirname build/Debug/GNU-Linux-x86/DP_server1.0.0` && $(TAR) DP_server1.0.0.tar DP_server1.0.0 && $(COMPRESS) DP_server1.0.0.tar) && $(MOVE) `dirname build/Debug/GNU-Linux-x86/DP_server1.0.0`/DP_server1.0.0.tar.gz . && $(DEL_FILE) -r build/Debug/GNU-Linux-x86/DP_server1.0.0
...
build/Debug/GNU-Linux-x86/CoordinationPosition.o: CoordinationPosition.cpp CoordinationPosition.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/CoordinationPosition.o CoordinationPosition.cpp

build/Debug/GNU-Linux-x86/CoveredArea.o: CoveredArea.cpp CoveredArea.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/CoveredArea.o CoveredArea.cpp

build/Debug/GNU-Linux-x86/CoveredAreas.o: CoveredAreas.cpp CoveredAreas.h \
		Position.h \
		CoordinationPosition.h \
		CoveredArea.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/CoveredAreas.o CoveredAreas.cpp
...
build/Debug/GNU-Linux-x86/NavigaciaUtil.o: NavigaciaUtil.cpp NavigationUtil.h \
		CoveredAreas.h \
		Position.h \
		CoordinationPosition.h \
		CoveredArea.h \
...
build/Debug/GNU-Linux-x86/Obstacle.o: Obstacle.cpp Obstacle.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/Obstacle.o Obstacle.cpp

build/Debug/GNU-Linux-x86/Position.o: Position.cpp Position.h \
		CoordinationPosition.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/Position.o Position.cpp
